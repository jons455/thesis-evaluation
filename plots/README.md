...
**Recommended Phase 3 figures for the thesis:** include **p3_1** (v12 vs PI envelope), **p3_4** (SyOps vs MAE Pareto), **p3_E1** (relative error vs PI), and **one of** **p3_V1** (v12 vs PI normalized) or **p3_V2** (log-ratio MAE). Plot 3.3 (ITAE grouped bar) is not currently generated by the script.
