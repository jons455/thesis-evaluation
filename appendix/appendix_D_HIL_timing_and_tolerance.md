...
--- SC-6a: Hardware Repeatability (R12 vs R13) ---
  Scenario: step_mid_speed_1500rpm_2A
    ...
    settling_time_i_q: R12=inf, R13=inf, dev=nan -> FAIL
...
--- SC-6c: Timing Characterization ---
  step_mid_speed_1500rpm_2A: round-trip=4.010 ms (p95=6.055), chip=381.4 us
    NOTE: round-trip (4.010 ms) > control timestep (0.1 ms)
  multi_step_bidirectional_1500rpm: round-trip=3.141 ms (p95=5.055), chip=372.7 us
    NOTE: round-trip (3.141 ms) > control timestep (0.1 ms)
...
Overall Phase 5: SC-6a=FAIL, SC-6c=Reported
```
